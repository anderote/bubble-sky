...
/** The sharpshooter tower block; holds a {@link SharpshooterTowerBlockEntity}. */
public class SharpshooterTowerBlock extends BlockWithEntity {
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state,
		...
		return validateTicker(type, ModBlockEntities.SHARPSHOOTER_TOWER, AbstractTowerBlockEntity::tick);
	}
}
